...
class _BotCommands:
    def __init__(self) -> None:
        ...
        self.MirrorCommand = f'{CMD_INDEX}'
        self.UnzipMirrorCommand = f'{CMD_INDEX}'
        self.ZipMirrorCommand = f'{CMD_INDEX}'
        ...
        self.LeechSetCommand = f'{CMD_INDEX}'
        self.SetThumbCommand = f'{CMD_INDEX}'
        self.LeechCommand = f'{CMD_INDEX}'
        self.UnzipLeechCommand = f'{CMD_INDEX}'
        self.ZipLeechCommand = f'{CMD_INDEX}'
        self.LeechWatchCommand = f'{CMD_INDEX}'
        self.LeechZipWatchCommand = f'{CMD_INDEX}'
